          ...
          <div class="row">
               <div class="panel panel-primary">
                  <div class="panel-body">
                   ...
                   <div class="class col-lg-2 col-sm-2 col-md-2 col-xs-12">  
                     <div class="form-group">
                  ...
                  <div class="class col-lg-12 col-sm-12 col-md-12 col-xs-12">
...
<script>
  ...
  $(document).ready(function(){
   ...
   function agregar()
   {
      ...
      articulo=$('#pidarticulo option:selected').tex();
      ...
      if (idarticulo!="" && cantidad!="" && cantidad>0 && precio_compra!="" && precio_venta!="") 
      {
         ...
         var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+idarticulo+'</td><td><input type="number" name="cantidad[]" value="'+cantidad+'">'+cantidad+'</td><td><input type="number" name="precio_compra[]" value="'+precio_compra+'">'+precio_compra+'</td><td><input type="number" name="precio_venta[]" value="'+precio_venta+'">'+precio_venta+'</td><td>'+subtotal[cont]+'</td></tr>';
         cont++;
         limpiar();
         $("#total").html("$/. " + total);
      ...
      {
         alert("Error al ingresar el detalle del ingreso, revise los datos de articulo")
      }
   }
